defmodule Jido.IntentLedger.Instance do
  @moduledoc """
  Convenience API for supervising named ledgers.
  """

  alias Jido.IntentLedger.Names

  @doc """
  Returns a child specification for a named ledger instance.
  """
  @spec child_spec(keyword()) :: Supervisor.child_spec()
  def child_spec(opts), do: Jido.IntentLedger.InstanceSupervisor.child_spec(opts)

  @doc """
  Starts a named ledger instance.
  """
  @spec start_link(keyword()) :: Supervisor.on_start()
  def start_link(opts), do: Jido.IntentLedger.InstanceSupervisor.start_link(opts)
